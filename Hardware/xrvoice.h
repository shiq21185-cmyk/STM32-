...
#define XRVOICE_OPEN_LID        0x02    // 打开盖子
#define XRVOICE_CLOSE_LID       0x03    // 关闭盖子
#define XRVOICE_LEFT            0x04    // 左转
#define XRVOICE_RIGHT           0x05    // 右转
#define XRVOICE_STOP            0x06    // 停止
#define XRVOICE_LIGHT_ON        0x07    // 开灯
#define XRVOICE_LIGHT_OFF       0x08    // 关灯
#define XRVOICE_SLEEP           0x09    // 休眠
#define XRVOICE_LEFT_SHIFT      0x0A    // 左平移
#define XRVOICE_RIGHT_SHIFT     0x0B    // 右平移
#define XRVOICE_CALL_GUARDIAN   0x0C    // 联系监护人
#define XRVOICE_VOL_UP          0x0D    // 增大音量
#define XRVOICE_VOL_DOWN        0x0E    // 减小音量
#define XRVOICE_VOL_MAX         0x0F    // 最大音量
#define XRVOICE_VOL_MID         0x10    // 中等音量
#define XRVOICE_VOL_MIN         0x11    // 最小音量
#define XRVOICE_ENABLE_REPORT   0x12    // 开启播报
...
// 播放原始命令（统一格式 AA 55 cmd_type cmd_id FB）
